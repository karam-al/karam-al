...
class ShortTermDaily extends StatefulWidget {
  @override
  _ShortTermDailyState createState() => _ShortTermDailyState();
}

class _ShortTermDailyState extends State<ShortTermDaily> {
  final myController = TextEditingController();
  dynamic _index = 10, api;
  dynamic newValuee;
  dynamic _selectedLocation, _selectedLocationPricePer;
  /////////////////////////////////////
  ...
  List<dynamic> type = ["ok"], shortTermDaily, pricePer; // Option 2
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        appBar: AppBar(
          ...
          title: Text(
            translator.translate("Add Short Term (Daily)2"),
              ...
              child: Column(
                  ...
                  children: <Widget>[
                    ...
                    _buildDropDown(translator.translate("Choose Type"),
                        shortTermDaily, 1, _selectedLocation, double.infinity),
                    SizedBox(
                      height: 5.w,
                    ),
                    Row(
...
class ShortTermDaily2 extends StatefulWidget {
  ...
  @override
  _ShortTermDaily2State createState() => _ShortTermDaily2State();
}

class _ShortTermDaily2State extends State<ShortTermDaily2>
                      ...
                      Container(
                        ...
                        child: ElevatedButton(
                          ...
                          onPressed: () async {
                            ...
                            if (translator.currentLanguage == 'en')
                              rootAPI = 2018;
                            await notesService.shortTermDailyForRent(
                                rootAPI,
                                widget.childAPI,
                                widget.title,
                                widget.price,
