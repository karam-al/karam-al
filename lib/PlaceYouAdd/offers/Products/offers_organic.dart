...
class OffersProductsOrganicInput extends StatefulWidget {
  @override
  _OffersProductsOrganicInputState createState() =>
      _OffersProductsOrganicInputState();
}

class _OffersProductsOrganicInputState
    extends State<OffersProductsOrganicInput> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        appBar: AppBar(
          ...
          title: Text(
            translator.translate("Add Organic Product"),
            style: TextStyle(color: Colors.black, fontSize: 5.w),
          ),
          elevation: 0,
                          ...
                          child: ElevatedButton(
                            ...
                            onPressed: () {
                              ...
                              Navigator.push(
                                ...
                                MaterialPageRoute(
                                  builder: (context) {
                                    return OffersProductsOrganicInput2(
                                      price: price,
                                      title: title,
...
class OffersProductsOrganicInput2 extends StatefulWidget {
  final dynamic price;
  final dynamic title, description;
  OffersProductsOrganicInput2({
    @required this.price,
    @required this.title,
  ...
  @override
  _OffersProductsOrganicInput2State createState() =>
      _OffersProductsOrganicInput2State();
}

class _OffersProductsOrganicInput2State
    extends State<OffersProductsOrganicInput2>
  ...
  double padding = 0,
      ...
      paddding47 = 0,
      paddding39 = 0;
  dynamic phoneNumber, discount, quentity, roomsCount, bathrooms,root,
      child;
...
void initState() {
  ...
  keyboardType: choice2 == 1 ? TextInputType.number : TextInputType.text,
        ...
        onSaved: (value) {
          ...
          if (choice == 5) quentity = NumberUtility.changeDigit(value, NumStrLanguage.English);
          if (choice == 6) website = value;
          if (choice == 7) email = value;
          if (choice == 8) location = value;
        },
      ),
    );
  }
          ...
          child: Form(
              ...
              child: Column(
                children: [
                  ...
                  _buildName(context, MediaQuery.of(context).size.width,
                      translator.translate("WebSite"), 6,2),
                  ...
                  _buildName(context, MediaQuery.of(context).size.width,
                      translator.translate("Email"), 7,2),
                      ...
                      Container(
                        ...
                        child: ElevatedButton(
                          ...
                          onPressed: () async {
                            ...
                            notesService.organic(widget.title,
                                root,
                                child,
                                widget.price,
                                widget.description, phoneNumber, 
                             discount, isItFree, quentity, 
