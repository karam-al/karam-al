...
class OffersProductsHealthBeautyInput extends StatefulWidget {
  @override
  _OffersProductsHealthBeautyInputState createState() =>
      _OffersProductsHealthBeautyInputState();
}

class _OffersProductsHealthBeautyInputState
    extends State<OffersProductsHealthBeautyInput> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        appBar: AppBar(
          ...
          title: Text(
            translator.translate("Add Health & Beauty Product"),
            style: TextStyle(color: Colors.black, fontSize: 5.w),
          ),
          elevation: 0,
                          ...
                          child: ElevatedButton(
                            ...
                            onPressed: () {
                              ...
                              Navigator.push(
                                ...
                                MaterialPageRoute(
                                  builder: (context) {
                                    return OffersProductsHealthBeautyInput2(
                                      price: price,
                                      title: title,
...
class OffersProductsHealthBeautyInput2 extends StatefulWidget {
  final dynamic price;
  final dynamic title, description;
  OffersProductsHealthBeautyInput2({
    @required this.price,
    @required this.title,
  ...
  @override
  _OffersProductsHealthBeautyInput2State createState() =>
      _OffersProductsHealthBeautyInput2State();
}

class _OffersProductsHealthBeautyInput2State
    extends State<OffersProductsHealthBeautyInput2>
  ...
  List<dynamic> listedBy, menu, room, guests; // Option 2
