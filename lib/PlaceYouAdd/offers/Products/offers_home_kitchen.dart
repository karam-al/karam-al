...
class OffersProductsHomeKitchenInput extends StatefulWidget {
  @override
  _OffersProductsHomeKitchenInputState createState() =>
      _OffersProductsHomeKitchenInputState();
}

class _OffersProductsHomeKitchenInputState
    extends State<OffersProductsHomeKitchenInput> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        appBar: AppBar(
          ...
          title: Text(
            translator.translate("Add Home & Kitchen"),
            style: TextStyle(color: Colors.black, fontSize: 5.w),
          ),
          elevation: 0,
                          ...
                          child: ElevatedButton(
                            ...
                            onPressed: () {
                              ...
                              Navigator.push(
                                ...
                                MaterialPageRoute(
                                  builder: (context) {
                                    return OffersProductsHomeKitchenInput2(
                                      price: price,
                                      title: title,
...
class OffersProductsHomeKitchenInput2 extends StatefulWidget {
  final dynamic price;
  final dynamic title, description;
  OffersProductsHomeKitchenInput2({
    @required this.price,
    @required this.title,
  ...
  @override
  _OffersProductsHomeKitchenInput2State createState() =>
      _OffersProductsHomeKitchenInput2State();
}

class _OffersProductsHomeKitchenInput2State
    extends State<OffersProductsHomeKitchenInput2>
