...
class OffersProductsPhoneTabPCInput extends StatefulWidget {
  @override
  _OffersProductsPhoneTabPCInputState createState() =>
      _OffersProductsPhoneTabPCInputState();
}

class _OffersProductsPhoneTabPCInputState
    extends State<OffersProductsPhoneTabPCInput> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        appBar: AppBar(
          ...
          title: Text(
            translator.translate("Add Phone & Tab & PC"),
            style: TextStyle(color: Colors.black, fontSize: 5.w),
          ),
          elevation: 0,
                          ...
                          child: ElevatedButton(
                            ...
                            onPressed: () {
                              ...
                              Navigator.push(
                                ...
                                MaterialPageRoute(
                                  builder: (context) {
                                    return OffersProductsPhoneTabPCInput2(
                                      price: price,
                                      title: title,
...
class OffersProductsPhoneTabPCInput2 extends StatefulWidget {
  final dynamic price;
  final dynamic title, description;
  OffersProductsPhoneTabPCInput2({
    @required this.price,
    @required this.title,
  ...
  @override
  _OffersProductsPhoneTabPCInput2State createState() =>
      _OffersProductsPhoneTabPCInput2State();
}

class _OffersProductsPhoneTabPCInput2State
    extends State<OffersProductsPhoneTabPCInput2>
  ...
  double padding = 0,
      ...
      paddding47 = 0,
      paddding39 = 0;
  dynamic phoneNumber, discount, quentity, roomsCount, bathrooms, root, child;
  List<dynamic> listedBy,
      ...
      color,
      memory; // Option 2
  dynamic location, website, email, age, model;
  Map<dynamic, bool> numbers;
  List<FreeHold> freeHold;
  dynamic _selectedLocationUsage,
      _selectedLocationCondition,
      _selectedLocationWarrantly,
      _selectedLocationColor,
      _selectedLocationMemory;
  dynamic _selectedLocationYearFrom,
      _selectedLocationMonthFrom,
      _selectedLocationDayFrom,
      _selectedLocationYearTo,
      _selectedLocationMonthTo,
      _selectedLocationDayTo;
  List<dynamic> year, month, day;
  dynamic isItFree = "IsIt";
  dynamic rating = 0;
  void initState() {
    super.initState();
      ...
      validator: (value) => value == null
        ...
        onChanged: (dynamic newValue) {
          setState(() {
            ...
            if (choice == 2) {
              _selectedLocationCondition = newValue;
            }
            if (choice == 3) {
              _selectedLocationWarrantly = newValue;
            }
            if (choice == 4) {
              _selectedLocationColor = newValue;
            }
            if (choice == 5) {
              _selectedLocationMemory = newValue;
            }
          });
        },
      ),
    ...
    return Container(
      ...
      child: TextFormField(
        ...
        onSaved: (value) {
          ...
          // if (choice == 3) offerdate = value; ====> for offer date
          // if (choice == 4) todate = value; ======> to date
          if (choice == 5) model = value;

          if (choice == 6) age = NumberUtility.changeDigit(value, NumStrLanguage.English);
          // if (choice == 7) website = value;
          // if (choice == 8) email = value;
          if (choice == 7) location = value;
        },
      ),
    );
  }
  ...
  Widget build(BuildContext context) {
    ...
    color = [
      ...
      translator.translate("Blue"),
      translator.translate("Gold"),
      translator.translate("Green"),
      translator.translate("Gray"),
      translator.translate("Multi Color"),
      translator.translate("Pink"),
      translator.translate("Purple"),
      translator.translate("Red"),
      translator.translate("Silver"),
      translator.translate("White"),
      translator.translate("Yellow"),
    ];
    memory = [
      translator.translate("1GB or less"),
      translator.translate("2GB"),
      translator.translate("3GB"),
      translator.translate("4GB"),
      translator.translate("6GB"),
      translator.translate("8GB and more"),
    ];
          ...
          child: Form(
              ...
              child: Column(
                children: [
                  ...
                  _buildDropDown(translator.translate('by Usage'), usage, 1,
                  ...
                  _buildName(context, double.infinity,
                      translator.translate("Model2"), 5, 2),
                  SizedBox(
                    height: 5.w,
                  ),
                  _buildDropDown(translator.translate('Warranty'), warrantly, 3,
                      _selectedLocationWarrantly, double.infinity),

                  SizedBox(
                    height: 5.w,
                  ),

                  _buildDropDown(translator.translate('Color'), color, 4,
                      _selectedLocationColor, double.infinity),
                  SizedBox(
                    height: 5.w,
                  ),
                  _buildDropDown(translator.translate('Memory'), memory, 5,
                      _selectedLocationMemory, double.infinity),
                  ...
                  Row(
                    children: [
                      _buildDropDown(translator.translate("Year2"), year, 10,
                          _selectedLocationYearFrom, 28.w),
                      SizedBox(
                        width: 2.w,
                      ),
                      _buildDropDown(translator.translate("Month"), month, 20,
                          _selectedLocationMonthFrom, 28.w),
                      SizedBox(
                        width: 2.w,
                      ),
                      _buildDropDown(translator.translate("Day"), day, 30,
                  ...
                  Row(
                    children: [
                      _buildDropDown(translator.translate("Year2"), year, 40,
                          _selectedLocationYearTo, 28.w),
                      SizedBox(
                        width: 2.w,
                      ),
                      _buildDropDown(translator.translate("Month"), month, 50,
                          _selectedLocationMonthTo, 28.w),
                      SizedBox(
                        width: 2.w,
                      ),
                      _buildDropDown(translator.translate("Day"), day, 60,
                  ...
                  _buildName(context, MediaQuery.of(context).size.width,
                      translator.translate("Location"), 7, 2),
