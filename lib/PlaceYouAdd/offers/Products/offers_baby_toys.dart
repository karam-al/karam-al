...
class OffersProductsBabyToysInput extends StatefulWidget {
  @override
  _OffersProductsBabyToysInputState createState() =>
      _OffersProductsBabyToysInputState();
}

class _OffersProductsBabyToysInputState
    extends State<OffersProductsBabyToysInput> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        appBar: AppBar(
          ...
          title: Text(
            translator.translate("Add Baby Acc & Toys"),
            style: TextStyle(color: Colors.black, fontSize: 5.w),
          ),
          elevation: 0,
                          ...
                          child: ElevatedButton(
                            ...
                            onPressed: () {
                              ...
                              Navigator.push(
                                ...
                                MaterialPageRoute(
                                  builder: (context) {
                                    return OffersProductsBabyToysInput2(
                                      price: price,
                                      title: title,
...
class OffersProductsBabyToysInput2 extends StatefulWidget {
  final dynamic price;
  final dynamic title, description;
  OffersProductsBabyToysInput2({
    @required this.price,
    @required this.title,
  ...
  @override
  _OffersProductsBabyToysInput2State createState() =>
      _OffersProductsBabyToysInput2State();
}

class _OffersProductsBabyToysInput2State
    extends State<OffersProductsBabyToysInput2>
