...
class OffersProductsCampingOutdoorInput extends StatefulWidget {
  @override
  _OffersProductsCampingOutdoorInputState createState() =>
      _OffersProductsCampingOutdoorInputState();
}

class _OffersProductsCampingOutdoorInputState
    extends State<OffersProductsCampingOutdoorInput> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        appBar: AppBar(
          ...
          title: Text(
            translator.translate("Add Camping & Outdoor Product"),
            style: TextStyle(color: Colors.black, fontSize: 4.4.w),
          ),
          elevation: 0,
                          ...
                          child: ElevatedButton(
                            ...
                            onPressed: () {
                              ...
                              Navigator.push(
                                ...
                                MaterialPageRoute(
                                  builder: (context) {
                                    return OffersProductsCampingOutdoorInput2(
                                      price: price,
                                      title: title,
...
class OffersProductsCampingOutdoorInput2 extends StatefulWidget {
  final dynamic price;
  final dynamic title, description;
  OffersProductsCampingOutdoorInput2({
    @required this.price,
    @required this.title,
  ...
  @override
  _OffersProductsCampingOutdoorInput2State createState() =>
      _OffersProductsCampingOutdoorInput2State();
}

class _OffersProductsCampingOutdoorInput2State
    extends State<OffersProductsCampingOutdoorInput2>
  ...
  List<dynamic> listedBy, menu, room, guests, usage, condition; // Option 2
  List<dynamic> year, month, day;
  dynamic location, website, email, age;
  List<FreeHold> freeHold;
  dynamic _selectedLocationUsage, _selectedLocationCondition;
    ...
    return Container(
      ...
      child: TextFormField(
        ...
        onSaved: (value) {
          ...
          if (choice == 6)
            age = NumberUtility.changeDigit(value, NumStrLanguage.English);
          if (choice == 7) website = value;
          if (choice == 8) email = value;
          if (choice == 9) location = value;
        },
      ),
    );
  }
          ...
          child: Form(
              ...
              child: Column(
                children: [
                  ...
                  _buildName(context, MediaQuery.of(context).size.width,
                      translator.translate("WebSite"), 7, 2),
                  ...
                  _buildName(context, MediaQuery.of(context).size.width,
                      translator.translate("Email"), 8, 2),
                  SizedBox(
                    height: 5.w,
                  ),
                  Row(
                      ...
                      Container(
                        ...
                        child: ElevatedButton(
                          ...
                          onPressed: () async {
                            ...
                            notesService.campingOutDoorsProducts(
                                widget.title,
                                root,
                                child,
                                widget.price,
