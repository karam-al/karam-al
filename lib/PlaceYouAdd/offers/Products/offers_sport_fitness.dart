...
class OffersProductsSportFitnessInput extends StatefulWidget {
  @override
  _OffersProductsSportFitnessInputState createState() =>
      _OffersProductsSportFitnessInputState();
}

class _OffersProductsSportFitnessInputState
    extends State<OffersProductsSportFitnessInput> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        appBar: AppBar(
          ...
          title: Text(
            translator.translate("Add Sport & Fitness"),
            style: TextStyle(color: Colors.black, fontSize: 5.w),
          ),
          elevation: 0,
                          ...
                          child: ElevatedButton(
                            ...
                            onPressed: () {
                              ...
                              Navigator.push(
                                ...
                                MaterialPageRoute(
                                  builder: (context) {
                                    return OffersProductsSportFitnessInput2(
                                      price: price,
                                      title: title,
...
class OffersProductsSportFitnessInput2 extends StatefulWidget {
  final dynamic price;
  final dynamic title, description;
  OffersProductsSportFitnessInput2({
    @required this.price,
    @required this.title,
  ...
  @override
  _OffersProductsSportFitnessInput2State createState() =>
      _OffersProductsSportFitnessInput2State();
}

class _OffersProductsSportFitnessInput2State
    extends State<OffersProductsSportFitnessInput2>
          ...
          child: Form(
              ...
              child: Column(
                children: [
                  ...
                  _buildName(context, MediaQuery.of(context).size.width,
                      translator.translate("Quentity"), 5, 1),
