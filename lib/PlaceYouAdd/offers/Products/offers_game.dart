...
class OffersProductsGameInput extends StatefulWidget {
  @override
  _OffersProductsGameInputState createState() =>
      _OffersProductsGameInputState();
}

class _OffersProductsGameInputState extends State<OffersProductsGameInput> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        appBar: AppBar(
          ...
          title: Text(
            translator.translate("Add Games"),
            style: TextStyle(color: Colors.black, fontSize: 5.w),
          ),
          elevation: 0,
                          ...
                          child: ElevatedButton(
                            ...
                            onPressed: () {
                              ...
                              Navigator.push(
                                ...
                                MaterialPageRoute(
                                  builder: (context) {
                                    return OffersProductsGameInput2(
                                      price: price,
                                      title: title,
...
class OffersProductsGameInput2 extends StatefulWidget {
  final dynamic price;
  final dynamic title, description;
  OffersProductsGameInput2({
    @required this.price,
    @required this.title,
  ...
  @override
  _OffersProductsGameInput2State createState() =>
      _OffersProductsGameInput2State();
}

class _OffersProductsGameInput2State extends State<OffersProductsGameInput2>
