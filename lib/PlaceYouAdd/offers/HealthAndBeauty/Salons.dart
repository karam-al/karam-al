...
class SalonsInput extends StatefulWidget {
  @override
  _SalonsInputState createState() => _SalonsInputState();
}

class _SalonsInputState extends State<SalonsInput> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        appBar: AppBar(
          ...
          title: Text(
            translator.translate("Add salon"),
            style: TextStyle(color: Colors.black, fontSize: 5.w),
          ),
          elevation: 0,
...
class SalonsInput2 extends StatefulWidget {
  ...
  @override
  _SalonsInput2State createState() => _SalonsInput2State();
}

class _SalonsInput2State extends State<SalonsInput2>
  ...
  List<dynamic> services, year, month, day; // Option 2
  ...
  void initState() {
    super.initState();
    services = [
      translator.translate("Hair"),
      translator.translate("MakeUp"),
      translator.translate("Pedicure"),
      translator.translate("Manicure"),
    ];
    year = [
      "2010",
      "2011",
      ...
      validator: (value) => value == null
        ...
        onChanged: (dynamic newValue) {
          setState(() {
            ...
            if (choice == 7) {
              _selectedLocationServices = newValue;
            }
          });
        },
      ),
          ...
          child: Form(
              ...
              child: Column(
                children: [
                  ...
                  _buildDropDown(translator.translate("Services"), services, 7,
                      _selectedLocationServices, double.infinity),
                  SizedBox(
                    height: 5.w,
                  ),
                  Row(
                  ...
                  _buildName(context, double.infinity,
                      translator.translate("Location"), 5, 2),
                  SizedBox(
                    height: 10.w,
                  ),
                  Row(
