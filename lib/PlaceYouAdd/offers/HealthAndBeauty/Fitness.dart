...
class FitnessInput extends StatefulWidget {
  @override
  _FitnessInputState createState() => _FitnessInputState();
}

class _FitnessInputState extends State<FitnessInput> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        appBar: AppBar(
          ...
          title: Text(
            translator.translate("Add Fitness"),
            style: TextStyle(color: Colors.black, fontSize: 5.w),
          ),
          elevation: 0,
...
class FitnessInput2 extends StatefulWidget {
  ...
  @override
  _FitnessInput2State createState() => _FitnessInput2State();
}

class _FitnessInput2State extends State<FitnessInput2>
  ...
  List<dynamic> workoutSchedule, year, month, day; // Option 2
  dynamic webSite, email, location, coachName;
  ...
  dynamic _selectedLocationYearFrom,
      ...
      _selectedLocationworkoutSchedule;
  bool subvalue = false;
  dynamic isItFree = "IsIt";
  dynamic rating = 0;
  void initState() {
      ...
      validator: (value) => value == null
        ...
        onChanged: (dynamic newValue) {
          setState(() {
            ...
            if (choice == 7) {
              _selectedLocationworkoutSchedule = newValue;
            }
          });
        },
      ),
  ...
  Widget build(BuildContext context) {
    workoutSchedule = [
      translator.translate("Cardio"),
      translator.translate("Weight Lifting"),
      translator.translate("Boxing"),
      translator.translate("Functional Training"),
    ];
    freeHold = [
      FreeHold(
        index: 1,
          ...
          child: Form(
              ...
              child: Column(
                children: [
                  ...
                  _buildDropDown(
                      translator.translate("Workout Schedule"),
                      workoutSchedule,
                      7,
                      _selectedLocationworkoutSchedule,
                      double.infinity),
                  ...
                  _buildName(context, double.infinity,
                      translator.translate("Coach name"), 3, 2),
                  SizedBox(
                    height: 5.w,
                  ),
                  Row(
