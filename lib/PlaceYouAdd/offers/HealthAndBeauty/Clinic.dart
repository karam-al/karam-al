...
class ClinicInput extends StatefulWidget {
  @override
  _ClinicInputState createState() => _ClinicInputState();
}

class _ClinicInputState extends State<ClinicInput> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        appBar: AppBar(
          ...
          title: Text(
            translator.translate("Add clinic"),
            style: TextStyle(color: Colors.black, fontSize: 5.w),
          ),
          elevation: 0,
...
class ClinicInput2 extends StatefulWidget {
  ...
  @override
  _ClinicInput2State createState() => _ClinicInput2State();
}

class _ClinicInput2State extends State<ClinicInput2>
  ...
  List<dynamic> year, month, day; // Option 2
              ...
              child: Column(
                children: [
                  ...
                  Row(
                    ...
                    children: [
                      _buildName(context, 42.w,
                          translator.translate("Doctor name"), 3, 2),
                      _buildName(context, 42.w,
                          translator.translate("Department"), 4, 2),
                    ],
                  ),
                  SizedBox(
                    height: 5.w,
