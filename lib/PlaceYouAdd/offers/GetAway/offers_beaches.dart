...
class OffersGetaAwayBeachesInput extends StatefulWidget {
  @override
  _OffersGetaAwayBeachesInputState createState() =>
      _OffersGetaAwayBeachesInputState();
}

class _OffersGetaAwayBeachesInputState
    extends State<OffersGetaAwayBeachesInput> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        appBar: AppBar(
          ...
          title: Text(
            translator.translate("Add Beaches"),
            style: TextStyle(color: Colors.black, fontSize: 5.w),
          ),
          elevation: 0,
                          ...
                          child: ElevatedButton(
                            ...
                            onPressed: () {
                              ...
                              Navigator.push(
                                ...
                                MaterialPageRoute(
                                  builder: (context) {
                                    return OffersGetaAwayBeachesInput2(
                                      price: price,
                                      title: title,
...
class OffersGetaAwayBeachesInput2 extends StatefulWidget {
  final dynamic price;
  final dynamic title, description;
  OffersGetaAwayBeachesInput2({
    @required this.price,
    @required this.title,
  ...
  @override
  _OffersGetaAwayBeachesInput2State createState() =>
      _OffersGetaAwayBeachesInput2State();
}

class _OffersGetaAwayBeachesInput2State
    extends State<OffersGetaAwayBeachesInput2>
  ...
  dynamic _selectedLocationoMenu, _selectedLocationRoom, _selectedLocationGuests;
      ...
      validator: (value) => value == null
        ...
        onChanged: (dynamic newValue) {
          setState(() {
            ...
            if (choice == 7) {
              _selectedLocationRoom = newValue;
            }
            if (choice == 8) {
    ...
    return Container(
      ...
      child: TextFormField(
        ...
        onSaved: (value) {
          ...
          if (choice == 5)
            roomsCount = NumberUtility.changeDigit(value, NumStrLanguage.English);
          if (choice == 6)
            bathrooms = NumberUtility.changeDigit(value, NumStrLanguage.English);
          ...
          child: Form(
              ...
              child: Column(
                children: [
                  ...
                  /////////////////////////////////
                  _buildDropDown(translator.translate('Choose Room Type'), room,
                      7, _selectedLocationRoom, double.infinity),
                  ...
                  Row(
                    ...
                    children: [
                      _buildName(context, 42.w,
                          translator.translate("Rooms Count"), 5, 1),
                      _buildName(context, 42.w,
                          translator.translate("Bathrooms"), 6, 1),
                    ],
                  ),
                  SizedBox(
                    height: 5.w,
