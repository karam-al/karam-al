...
class BungalowsInput extends StatefulWidget {
  @override
  _BungalowsInputState createState() => _BungalowsInputState();
}

class _BungalowsInputState extends State<BungalowsInput> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        appBar: AppBar(
          ...
          title: Text(
            translator.translate("Add bungalows"),
            style: TextStyle(color: Colors.black, fontSize: 5.w),
          ),
          elevation: 0,
...
class BungalowsInput2 extends StatefulWidget {
  ...
  @override
  _BungalowsInput2State createState() => _BungalowsInput2State();
}

class _BungalowsInput2State extends State<BungalowsInput2>
  ...
  List<dynamic> transportation, year, month, day; // Option 2
  dynamic webSite, email, location, destination, activities;
    ...
    return Container(
      ...
      child: TextFormField(
        ...
        onSaved: (value) {
          ...
          if (choice == 3) activities = value;
          if (choice == 4) destination = value;
          if (choice == 5) webSite = value;
          if (choice == 6) email = value;
              ...
              child: Column(
                children: [
                  ...
                  Row(
                    ...
                    children: [
                      _buildName(context, 42.w,
                          translator.translate("Activities"), 3, 2),
                      _buildName(context, 42.w,
                          translator.translate("Destination"), 4, 2)
                    ],
                  ),
                  SizedBox(
                    height: 5.w,
                  ...
                  _buildName(context, double.infinity,
                      translator.translate("WebSite"), 5, 2),
                  SizedBox(
                    height: 5.w,
                  ),
                  _buildName(context, double.infinity,
                      translator.translate("Email"), 6, 2),
                  SizedBox(
                    height: 5.w,
                  ),
                  Row(
