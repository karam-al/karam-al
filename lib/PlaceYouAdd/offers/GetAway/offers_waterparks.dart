...
class OffersGetaAwayWaterparksInput extends StatefulWidget {
  @override
  _OffersGetaAwayWaterparksInputState createState() =>
      _OffersGetaAwayWaterparksInputState();
}

class _OffersGetaAwayWaterparksInputState
    extends State<OffersGetaAwayWaterparksInput> {
  ...
  Widget build(BuildContext context) { 
    ...
    return Scaffold(
        ...
        appBar: AppBar(
          ...
          title: Text(
            translator.translate("Add Waterparks"),
            style: TextStyle(color: Colors.black, fontSize: 5.w),
          ),
          elevation: 0,
                          ...
                          child: ElevatedButton(
                            ...
                            onPressed: () {
                              ...
                              Navigator.push(
                                ...
                                MaterialPageRoute(
                                  builder: (context) {
                                    return OffersGetaAwayWaterparksInput2(
                                      price: price,
                                      title: title,
...
class OffersGetaAwayWaterparksInput2 extends StatefulWidget {
  final dynamic price;
  final dynamic title, description;
  OffersGetaAwayWaterparksInput2({
    @required this.price,
    @required this.title,
  ...
  @override
  _OffersGetaAwayWaterparksInput2State createState() =>
      _OffersGetaAwayWaterparksInput2State();
}

class _OffersGetaAwayWaterparksInput2State
    extends State<OffersGetaAwayWaterparksInput2>
    ...
    return Container(
      ...
      child: TextFormField(
        ...
        onSaved: (value) {
          ...
          if (choice == 5) events = value;
          if (choice == 8) website = value;
          if (choice == 9) email = value;
          if (choice == 10) location = value;
        },
      ),
    );
  }
          ...
          child: Form(
              ...
              child: Column(
                children: [
                  ...
                  _buildName(context, MediaQuery.of(context).size.width,
                      translator.translate("Events"), 5, 2),
                  SizedBox(
                    height: 5.w,
                  ),
                  _buildName(context, MediaQuery.of(context).size.width,
                      translator.translate("WebSite"), 8, 2),
                  ...
                  _buildName(context, MediaQuery.of(context).size.width,
                      translator.translate("Email"), 9, 2),
