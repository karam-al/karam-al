...
class OffersGetaAwayChaletsInput extends StatefulWidget {
  @override
  _OffersGetaAwayChaletsInputState createState() =>
      _OffersGetaAwayChaletsInputState();
}

class _OffersGetaAwayChaletsInputState
    extends State<OffersGetaAwayChaletsInput> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        appBar: AppBar(
          ...
          title: Text(
            translator.translate("Add Chalets"),
            style: TextStyle(color: Colors.black, fontSize: 5.w),
          ),
          elevation: 0,
                          ...
                          child: ElevatedButton(
                            ...
                            onPressed: () {
                              ...
                              Navigator.push(
                                ...
                                MaterialPageRoute(
                                  builder: (context) {
                                    return OffersGetaAwayChaletsInput2(
                                      price: price,
                                      title: title,
...
class OffersGetaAwayChaletsInput2 extends StatefulWidget {
  final dynamic price;
  final dynamic title, description;
  OffersGetaAwayChaletsInput2({
    @required this.price,
    @required this.title,
  ...
  @override
  _OffersGetaAwayChaletsInput2State createState() =>
      _OffersGetaAwayChaletsInput2State();
}

class _OffersGetaAwayChaletsInput2State
    extends State<OffersGetaAwayChaletsInput2>
  ...
  List<dynamic> listedBy,
      ...
      room,
      guests; // Option 2
  dynamic location, website, email
      //radioItem
      ;
