...
class ResortsInput extends StatefulWidget {
  @override
  _ResortsInputState createState() => _ResortsInputState();
}

class _ResortsInputState extends State<ResortsInput> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        appBar: AppBar(
          ...
          title: Text(
            translator.translate("Add resorts"),
            style: TextStyle(color: Colors.black, fontSize: 5.w),
          ),
          elevation: 0,
...
class ResortsInput2 extends StatefulWidget {
  ...
  @override
  _ResortsInput2State createState() => _ResortsInput2State();
}

class _ResortsInput2State extends State<ResortsInput2>
