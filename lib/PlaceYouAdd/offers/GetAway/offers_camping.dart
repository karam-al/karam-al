...
class OffersGetaAwayCampingInput extends StatefulWidget {
  @override
  _OffersGetaAwayCampingInputState createState() =>
      _OffersGetaAwayCampingInputState();
}

class _OffersGetaAwayCampingInputState
    extends State<OffersGetaAwayCampingInput> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        appBar: AppBar(
          ...
          title: Text(
            translator.translate("Add Camping"),
            style: TextStyle(color: Colors.black, fontSize: 5.w),
          ),
          elevation: 0,
                          ...
                          child: ElevatedButton(
                            ...
                            onPressed: () {
                              ...
                              Navigator.push(
                                ...
                                MaterialPageRoute(
                                  builder: (context) {
                                    return OffersGetaAwayCampingInput2(
                                      price: price,
                                      title: title,
...
class OffersGetaAwayCampingInput2 extends StatefulWidget {
  final dynamic price;
  final dynamic title, description;
  OffersGetaAwayCampingInput2({
    @required this.price,
    @required this.title,
  ...
  @override
  _OffersGetaAwayCampingInput2State createState() =>
      _OffersGetaAwayCampingInput2State();
}

class _OffersGetaAwayCampingInput2State
    extends State<OffersGetaAwayCampingInput2>
  ...
  List<dynamic> listedBy, year, month, day, transportation; // Option 2
  dynamic location,
  ...
  dynamic _selectedLocationTransportation;
      ...
      validator: (value) => value == null
        ...
        onChanged: (dynamic newValue) {
          setState(() {
            ...
            if (choice == 7) {
              _selectedLocationTransportation = newValue;
            }
          });
        },
      ),
    ...
    return Container(
      ...
      child: TextFormField(
        ...
        onSaved: (value) {
          ...
          if (choice == 5) activities = value;
          if (choice == 6) destination = value;
  ...
  Widget build(BuildContext context) {
    transportation = [
      translator.translate("By Bus"),
      translator.translate("By Train"),
      translator.translate("By Walking")
    ];
    if (MediaQuery.of(context).orientation == Orientation.portrait) {
      padding3 = 20.h;
      padding = 6.w;
              ...
              child: Column(
                children: [
                  ...
                  Row(
                    ...
                    children: [
                      _buildName(context, 42.w,
                          translator.translate("Activities"), 5, 2),
                      _buildName(context, 42.w,
                          translator.translate("Destination"), 6, 2),
                    ],
                  ),
                  SizedBox(
                    height: 5.w,
                  ...
                  _buildDropDown(
                      ...
                      transportation,
                      7,
                      _selectedLocationTransportation,
                      double.infinity),
