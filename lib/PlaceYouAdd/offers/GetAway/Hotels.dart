...
class GetaawayHotels extends StatefulWidget {
  @override
  _GetaawayHotelsState createState() => _GetaawayHotelsState();
}

class _GetaawayHotelsState extends State<GetaawayHotels> {
  final myController = TextEditingController();

  double padding = 0, padding2 = 0, leadingSize = 0;
  dynamic price, residentialBuildingAPI;
  dynamic title, description, basename;
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        appBar: AppBar(
          ...
          title: Text(
            translator.translate("Add hotel"),
            style: TextStyle(color: Colors.black, fontSize: 5.w),
          ),
          elevation: 0,
...
class GetaawayHotels2 extends StatefulWidget {
  ...
  @override
  _GetaawayHotels2State createState() => _GetaawayHotels2State();
}

class _GetaawayHotels2State extends State<GetaawayHotels2>
  ...
  double padding = 0,
      ...
      paddding47 = 0,
      paddding39 = 0;
  dynamic phoneNumber, discount, roomCount, bathroom, root, child;
  List<dynamic> roomType, guests, year, month, day; // Option 2
  dynamic webSite, email, location;
  ...
  void initState() {
    ...
    numbers = {
      translator.translate("Restaurant"): false,
      translator.translate("Swimming Pool"): false,
    };
      ...
      child: DropdownButtonFormField(
        ...
        onChanged: (dynamic newValue) {
          setState(() {
            ...
            if (choice == 8) {
              _selectedLocationguests = newValue;
            }
          });
        },
      ),
  ...
  Widget _buildName(BuildContext context, double x, dynamic text,
    ...
    return Container(
      ...
      child: TextFormField(
        ...
        onSaved: (value) {
          if (choice == 1)
            roomCount = NumberUtility.changeDigit(value, NumStrLanguage.English);
          if (choice == 2)
            bathroom = NumberUtility.changeDigit(value, NumStrLanguage.English);
          if (choice == 3) webSite = value;
          if (choice == 4) email = value;
          if (choice == 5)
  ...
  Widget build(BuildContext context) {
    roomType = [
      translator.translate("Superior room"),
      translator.translate("Classic room"),
      translator.translate("Deluxe room"),
      translator.translate("Lexury room"),
      translator.translate("Family room"),
      translator.translate("Suite"),
      translator.translate("Single room"),
      translator.translate("Double room"),
    ];
    guests = [translator.translate("Children"), translator.translate("Adults")];
    freeHold = [
      FreeHold(
        index: 1,
          ...
          child: Form(
              ...
              child: Column(
                children: [
                  ...
                  _buildDropDown(translator.translate("Room Type"), roomType, 7,
                      _selectedLocationroomType, double.infinity),
                  SizedBox(
                    height: 5.w,
                  ),
                  _buildDropDown(translator.translate("Choose Guests"), guests,
                      8, _selectedLocationguests, double.infinity),
                  SizedBox(
                    height: 5.w,
                  ),
                  Row(
                    ...
                    children: [
                      _buildName(context, 42.w,
                          translator.translate("Rooms Count"), 1, 1),
                      _buildName(context, 42.w,
                          translator.translate("Bathrooms"), 2, 1),
                    ],
                  ),
                  SizedBox(
                    height: 5.w,
                  ...
                  _buildName(context, double.infinity,
                      translator.translate("WebSite"), 3, 2),
                  SizedBox(
                    height: 5.w,
                  ),
                  _buildName(context, double.infinity,
                      translator.translate("Email"), 4, 2),
                  SizedBox(
                    height: 5.w,
                  ),
                  Row(
                    ...
                    children: [
                      _buildName(context, 42.w,
                          translator.translate("Your phone number"), 5, 1),
                      subvalue == false
                          ? _buildName(context, 42.w,
                              translator.translate("Discount"), 6, 1)
                          : Container(),
                    ],
                  ),
                  CheckboxListTile(
