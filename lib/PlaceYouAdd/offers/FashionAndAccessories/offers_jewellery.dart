...
class OffersFashionAccessoriesJewelleryInput extends StatefulWidget {
  @override
  _OffersFashionAccessoriesJewelleryInputState createState() =>
      _OffersFashionAccessoriesJewelleryInputState();
}

class _OffersFashionAccessoriesJewelleryInputState
    extends State<OffersFashionAccessoriesJewelleryInput> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        appBar: AppBar(
          ...
          title: Text(
            translator.translate("Add Jewellery"),
            style: TextStyle(color: Colors.black, fontSize: 5.w),
          ),
          elevation: 0,
                          ...
                          child: ElevatedButton(
                            ...
                            onPressed: () {
                              ...
                              Navigator.push(
                                ...
                                MaterialPageRoute(
                                  builder: (context) {
                                    return OffersFashionAccessoriesJewelleryInput2(
                                      price: price,
                                      title: title,
...
class OffersFashionAccessoriesJewelleryInput2 extends StatefulWidget {
  final dynamic price;
  final dynamic title, description;
  OffersFashionAccessoriesJewelleryInput2({
    @required this.price,
    @required this.title,
  ...
  @override
  _OffersFashionAccessoriesJewelleryInput2State createState() =>
      _OffersFashionAccessoriesJewelleryInput2State();
}

class _OffersFashionAccessoriesJewelleryInput2State
    extends State<OffersFashionAccessoriesJewelleryInput2>
