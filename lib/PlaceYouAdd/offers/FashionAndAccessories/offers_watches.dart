...
class OffersFashionAccessoriesWatchesInput extends StatefulWidget {
  @override
  _OffersFashionAccessoriesWatchesInputState createState() =>
      _OffersFashionAccessoriesWatchesInputState();
}

class _OffersFashionAccessoriesWatchesInputState
    extends State<OffersFashionAccessoriesWatchesInput> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        appBar: AppBar(
          ...
          title: Text(
            translator.translate("Add Watches"),
            style: TextStyle(color: Colors.black, fontSize: 5.w),
          ),
          elevation: 0,
                          ...
                          child: ElevatedButton(
                            ...
                            onPressed: () {
                              ...
                              Navigator.push(
                                ...
                                MaterialPageRoute(
                                  builder: (context) {
                                    return OffersFashionAccessoriesWatchesInput2(
                                      price: price,
                                      title: title,
...
class OffersFashionAccessoriesWatchesInput2 extends StatefulWidget {
  final dynamic price;
  final dynamic title, description;
  OffersFashionAccessoriesWatchesInput2({
    @required this.price,
    @required this.title,
  ...
  @override
  _OffersFashionAccessoriesWatchesInput2State createState() =>
      _OffersFashionAccessoriesWatchesInput2State();
}

class _OffersFashionAccessoriesWatchesInput2State
    extends State<OffersFashionAccessoriesWatchesInput2>
    ...
    return Container(
      ...
      child: TextFormField(
        ...
        onSaved: (value) {
          ...
          if (choice == 5) age = NumberUtility.changeDigit(value, NumStrLanguage.English);
