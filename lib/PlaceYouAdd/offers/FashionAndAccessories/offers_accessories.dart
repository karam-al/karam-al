...
class OffersFashionAccessoriesAccessoriesInput extends StatefulWidget {
  @override
  _OffersFashionAccessoriesAccessoriesInputState createState() =>
      _OffersFashionAccessoriesAccessoriesInputState();
}

class _OffersFashionAccessoriesAccessoriesInputState
    extends State<OffersFashionAccessoriesAccessoriesInput> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        appBar: AppBar(
          ...
          title: Text(
            translator.translate("Add Accessories"),
            style: TextStyle(color: Colors.black, fontSize: 5.w),
          ),
          elevation: 0,
                          ...
                          child: ElevatedButton(
                            ...
                            onPressed: () {
                              ...
                              Navigator.push(
                                ...
                                MaterialPageRoute(
                                  builder: (context) {
                                    return OffersFashionAccessoriesAccessoriesInput2(
                                      price: price,
                                      title: title,
...
class OffersFashionAccessoriesAccessoriesInput2 extends StatefulWidget {
  final dynamic price;
  final dynamic title, description;
  OffersFashionAccessoriesAccessoriesInput2({
    @required this.price,
    @required this.title,
  ...
  @override
  _OffersFashionAccessoriesAccessoriesInput2State createState() =>
      _OffersFashionAccessoriesAccessoriesInput2State();
}

class _OffersFashionAccessoriesAccessoriesInput2State
    extends State<OffersFashionAccessoriesAccessoriesInput2>
