...
class ClothingInput extends StatefulWidget {
  ...
  @override
  _ClothingInputState createState() => _ClothingInputState();
}

class _ClothingInputState extends State<ClothingInput> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        appBar: AppBar(
          ...
          title: Text(
            translator.translate("${widget.name}"),
            style: TextStyle(color: Colors.black, fontSize: 5.w),
          ),
          elevation: 0,
...
class ClothingInput2 extends StatefulWidget {
  final dynamic price, residentialBuildingAPI, choice;
  final dynamic title, description, name;
  ClothingInput2({
    @required this.price,
    @required this.title,
  ...
  @override
  _ClothingInput2State createState() => _ClothingInput2State();
}

class _ClothingInput2State extends State<ClothingInput2>
  ...
  List<dynamic> year, month, day, size; // Option 2
  dynamic webSite, email, location, doctorName, department;
    ...
    return Container(
      ...
      child: TextFormField(
        ...
        onSaved: (value) {
          ...
          if (choice == 3) doctorName = value;
          if (choice == 4) department = value;
          ...
          child: Form(
              ...
              child: Column(
                children: [
                  ...
                  _buildDropDown(translator.translate("Size"), size, 6,
                      _selectedLocationSize, double.infinity),
                  SizedBox(
                    height: 5.w,
                  ),
                  Row(
                      ...
                      Container(
                        ...
                        child: ElevatedButton(
                          ...
                          onPressed: () async {
                            ...
                            if (widget.choice == 1) {
                              sizeKey = "size_458";
                              websiteKey = "website_615";
                              emailKey = "email_815";//Womens
                            ...
                            if (widget.choice == 2) {//Man
                              sizeKey = "size_23";
                              websiteKey = "website_617";
                              emailKey = "email_592";
                              if (translator.currentLanguage == 'ar') {
                                root = 8652;
                                child = 8718;
                            ...
                            if (widget.choice == 3) {//Kids
                              sizeKey = "size";
                              websiteKey = "website_323";
                              emailKey = "email_234";
                              if (translator.currentLanguage == 'ar') {
                                root = 8652;
                                child = 8720;
