...
import 'package:oxydu/Data/AutogeneratedForSale.dart';
import 'package:oxydu/Data/ForRent/classes/ServiceForSale.dart';
import '../WaterMark.dart';
import 'package:sizer/sizer.dart';

import 'BuyItemSaleManagement.dart';
...
List<ForSale> _searchList = List();
List<ForSale> countries, result;
...
class ForSaleSection extends StatefulWidget {
  @override
  State createState() => ForSaleSectionState();
...
class ForSaleSectionState extends State<ForSaleSection> {
  BuyItemSaleStateManagement get obj => GetIt.I<BuyItemSaleStateManagement>();
...
////////////////////////////////////////////////////////////
  ...
  List<ForSale> _buildSortList() {
    if (id == 10)
      result.sort((b, a) => (a.acf.priceSale).compareTo(b.acf.priceSale));
    if (id == 1)
      result.sort((a, b) => (a.acf.priceSale).compareTo(b.acf.priceSale));
    if (id == 2)
      result.sort((b, a) => (a.acf.priceSale).compareTo(b.acf.priceSale));
    if (id == 3)
      result.sort((a, b) => (a.acf.priceSale).compareTo(b.acf.priceSale));
  ...
  final categories = ServiceForSale();
  ...
  List<ForSale> _buildFilterList() {
    _searchList = countries
        .where((element) =>
            int.parse(element.acf.priceSale) >=
  ...
  Widget createGridItem(int position, List<ForSale> data, int index,
    ...
    var result = "0";
    if (data[index].acf.priceSale.isNotEmpty) {
      result = NumberFormat.compactCurrency(
        decimalDigits: 2,
        symbol: '',
      ).format(double.parse(data[index].acf.priceSale));
    }
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                SizedBox(
                  ...
                  child: Stack(children: [
                    Carousel(
                      ...
                      images: [
                        for (int i = 0;
                            i < data[index].acf.galleryForSale.length;
                            i++)
                          watermark("${data[index].acf.galleryForSale[i]}"),
                        // for (int i = 0; i <= 2; i++)
                        //   watermark(data[index].acf.galleryForSale[0]),
                        // watermark(
                ...
                Row(
                  children: [
                    Text(translator.translate("Listed by2"),
                        textAlign: TextAlign.left,
                        style: new TextStyle(
                            fontSize: paddding36,
                            fontWeight: FontWeight.w600,
                            color: Colors.black)),
                    // Text(data[index].acf.listedBy,
                ...
                //                 fontWeight: FontWeight.w600,
                //                 color: Colors.black)),
                //         Text("${data[index].acf.sqftForSale}",
                //             textAlign: TextAlign.left,
                //             style: new TextStyle(
                //                 fontSize: paddding36, color: Colors.grey[600])),
                //       ],
                ...
                SizedBox(
                    ...
                    child: Row(
                      children: [
                        Text(translator.translate("landlord or agent: "),
                            textAlign: TextAlign.left,
                            style: new TextStyle(
                                fontSize: paddding36,
                                fontWeight: FontWeight.w600,
                        ...
                        Text(data[index].acf.landOrAgent,
                            textAlign: TextAlign.left,
                            style: new TextStyle(
                                fontSize: paddding36,
                                //fontWeight: FontWeight.bold,
