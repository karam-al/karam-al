...
import 'package:oxydu/Data/Offers/AutoGeneratedOffers.dart';
import 'package:oxydu/Data/Offers/ServiceOffers.dart';
import '../WaterMark.dart';
import 'package:sizer/sizer.dart';

import 'BuyItemOffersManagement.dart';
...
List<OffersParse> _searchList = List();
List<OffersParse> countries, result;
...
class Offers extends StatefulWidget {
  ...
  final int api;
  Offers({@required this.carModel, @required this.api});
}
...
class OffersState extends State<Offers> {
 BuyItemOffersStateManagement get obj => GetIt.I<BuyItemOffersStateManagement>();
  ...
  List<OffersParse> _buildSearchList() {
...
////////////////////////////////////////////////////////////
  ...
  List<OffersParse> _buildSortList() {
  ...
  final categories = ServiceOffers();
  ...
  List<OffersParse> _buildFilterList() {
  ...
  Widget createGridItem(int position, List<OffersParse> data, int index,
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                  ...
                  child: Stack(children: [
                    Carousel(
                      ...
                      images: [
                        ...
                        //watermark("${data[index].acf.gallery[0]}"),
                        /* watermark(
                ...
                Row(
                  children: [
                    Text(translator.translate("Offer Date"),
                        ...
                        style: new TextStyle(
                            ...
                            color: Colors.black)),
                    /*  Text(
                        data[index].acf.toDate.length > substring3
                            ? data[index]
                                    .acf
                                    .rentIsPaid
